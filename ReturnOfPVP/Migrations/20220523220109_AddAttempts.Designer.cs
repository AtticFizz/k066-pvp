...
namespace ReturnOfPVP.Migrations
{
    ...
    [Migration("20220523220109_AddAttempts")]
            ...
            modelBuilder.Entity("ReturnOfPVP.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            Created = new DateTime(2022, 5, 23, 22, 1, 8, 429, DateTimeKind.Utc).AddTicks(349),
                            Email = "admin@returnofpvp.com",
                            PasswordHash = "$2a$11$nfoEKucmXWnvhjNvRRFtu.3zY1qhsSJ.q/lpOQzJzjFWn3dEF39PO",
                            Role = 0,
                            Verified = new DateTime(2022, 5, 23, 22, 1, 8, 429, DateTimeKind.Utc).AddTicks(359)
                        });
                });
