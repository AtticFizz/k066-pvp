...
namespace ReturnOfPVP.Migrations
{
    ...
    [Migration("20220523205802_AddQuizToQuestion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReturnOfPVP.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            Created = new DateTime(2022, 5, 23, 20, 58, 1, 863, DateTimeKind.Utc).AddTicks(8199),
                            Email = "admin@returnofpvp.com",
                            PasswordHash = "$2a$11$zz.oiwqxZiQJdGSMfVobRumefn7mrlQH4kfCdy78.7NS3LGISyEpq",
                            Role = 0,
                            Verified = new DateTime(2022, 5, 23, 20, 58, 1, 863, DateTimeKind.Utc).AddTicks(8208)
                        });
                });
            ...
            modelBuilder.Entity("QuestionQuiz", b =>
                {
                    b.HasOne("ReturnOfPVP.Entities.Question", null)
                        .WithMany()
