...
namespace ReturnOfPVP.Migrations
{
    ...
    [Migration("20220523193524_AddQuiz")]
            ...
            modelBuilder.Entity("ReturnOfPVP.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            Created = new DateTime(2022, 5, 23, 19, 35, 24, 246, DateTimeKind.Utc).AddTicks(1894),
                            Email = "admin@returnofpvp.com",
                            PasswordHash = "$2a$11$G.GnHFdns1RgI5gcKO4NaOF9qKRwas/pSBTayL1w54f4duH/xfc8K",
                            Role = 0,
                            Verified = new DateTime(2022, 5, 23, 19, 35, 24, 246, DateTimeKind.Utc).AddTicks(1903)
                        });
                });
